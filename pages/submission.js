	...
	return (
		<PageTemplate metaTitle="Submission">
			...
			<p>
				...
				projects, philosophical meditations on art-science methodology, expanded
				descriptions of specific (media) art projects, and critical
				...
				would be of interest to the communities participating in IEEE VIS 2022.
			</p>
			...
			<p>
				...
				<a href="https://www.cspaul.com/vgtc/vgtc_conference_word.zip">Word</a>{" "}
				and{" "}
			...
			<h6>Acceptance</h6>
			<p>
				Accepted authors will present their work in one of the two VISAP Papers
				sessions - virtually or in-person - during the conference. All accepted
				papers will be published online in the IEEE VIS 2022 Arts Program
				proceedings, and indexed in the IEEE Xplore digital library.
			</p>
			...
			<p>
				These submissions reflect either on shared concepts among a selection of
				visualizations, or on the design process of a single work. Whether in
				the case of a single artifact, or, in the case of a series of artifacts,
				the designer is in a unique position to provide valuable insights into
				the design intentions, the design space explorations, and the design
				process (Löwgren 2013). Through pictorials and annotated portfolios, we
				invite submissions that communicate the visualization practices in rich,
				heavily visual ways.
			</p>
			...
			<p>
				...
				situated and rich nature of design. See{" "}
			...
			<p>
				...
				and{" "}
				<a href="https://visap.net/templates/VISAP_pictorial_Word.zip">Word</a>{" "}
			...
			<p>
				...
				<a href="http://visap.net/2018/media/Hunter-VISAP18-AP.pdf">5</a>) from
				the inaugural edition of this format in the{" "}
				...
				the <a href="https://visap.net/2020/program.html">2020 program</a>, and
				the five pictorials (
			...
			<p>
				...
				booklets and showcased in the VISAP’22 catalog, which will be available
				both online and in print. Selected submissions will be invited to
			...
			<ol>
				<li>
					<strong>General Information</strong>: Title of the work, Year, Authors
					(and roles), Medium and Dimensions of the work
				</li>
				<li>
					...
					visualization, and/or visual analytics. Discuss the reception of your
					work at previous exhibitions (if it has been exhibited before)
				</li>
				<li>
					...
					there any time of day requirements? Does it require any specific space
					or technical setup (e.g. VR gadgets or audiovisual equipment)?
					Consider how your artwork could be integrated in both a physical and
					virtual art exhibition
				</li>
				<li>
					<strong>Supporting Material</strong>: Provide links to high-resolution
					images, audio, webpages and/or videos that will help give the
					reviewers a clear sense of your work
				</li>
			</ol>
			<h6>Example topics</h6>
			...
			<p>
				Please see the{" "}
				<a href="https://visap.net/media/VISAP21-Catalogue.pdf">2021 catalog</a>{" "}
				...
				<a href="https://visap.net/media/VISAP19-Catalogue.pdf">2019 catalog</a>{" "}
				...
				contact the chairs if you have questions about whether or not your work
				is an appropriate submission to VISAP.
			</p>
			<h6>Acceptance</h6>
			<p>
				All accepted work will be included in the online proceedings of VISAP on
				the visap.net website, as well as in a catalog that will be shared on
				the visap website. In addition to accepting installations that may be
				featured on the in-person or online exhibition, some artworks may be
				selected for artist talks during the week of the IEEE VIS conference.
				Performance submissions may also be scheduled for specific times during
				the exhibition. Artists will work with the VISAP organizers on details
				for showcasing their artworks in the online exhibition. Artists and
			...
			<p>
				...
				the opening reception, and to participate in the program throughout the
				week (again, either virtually or in-person).
				<br />
				No artist fee is provided. There are some complimentary day
				registrations available for selected artists. Priority will be given to
				exhibiting artists. We invite students to apply to the IEEE VIS student
				volunteer program to help cover registration fees. We also invite
				authors and artists who demonstrate financial need to apply for the IEEE
