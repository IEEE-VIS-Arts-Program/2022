			...
			<Container fluid>
				<Row>
					<Col md={{ span: 6, offset: 3 }}>
						...
						<p>
							We invite researchers, scholars, and creative practitioners to
							submit papers related to the theme <i>Mingling Spaces</i>. We
							encourage submissions such as technical descriptions of creative
							visualization projects, philosophical meditations on art-science
							methodology, expanded descriptions of specific (media) art
							projects, and critical interpretations of visualization approaches
							and practices. We are open to any submission that relates in some
						...
						<ul>
							...
							<li>
								the influence of visualization techniques on art or design
								practices
							</li>
							<li>
						...
						<p>
							...
							However, including keywords and index terms is optional.
						</p>
						<p>
							Paper submissions must not exceed 10 pages—including all figures
							and references.
						</p>
						<p>
						...
						<p>
							...
							All accepted papers will be published online in the IEEE VIS 2022
						...
						<p>
							...
							<a href="http://visap.uic.edu/2013/#program">2013</a>) for
							examples of accepted submissions. (Selected VISAP papers have also
							been featured in IEEE Computer Graphics and Applications and
							Leonardo).
						</p>
						...
						<p>
							Artists, designers, and researchers all make creative choices
							based on practical knowledge, generally acquired through
							experience. Unfortunately, this knowledge is seldom shared in
							publications. VISAP Pictorials aim to foster discussions around
							this reflection-in-action when creating visualizations or
							data-driven art pieces.
						</p>
						<p>
							These submissions reflect either on shared concepts among a
							selection of visualizations, or on the design process of a single
							work. Whether in the case of a single artifact, or, in the case of
							a series of artifacts, the designer is in a unique position to
							provide valuable insights into the design intentions, the design
							space explorations, and the design process (Löwgren 2013). Through
							pictorials and annotated portfolios, we invite submissions that
						...
						<p>
							...
							textual annotations. It has been proposed by Gaver and Bowers
							(2012) as a “way to communicate design research”. The systematic
							selection and annotation of the artifacts are part of the
							contribution. Submitters are encouraged to highlight important
						...
						<p>
							...
							encourage submitters to use the space in the most creative and
							visual way.
						</p>
						<p>
							Submitting supplementary material and/or links to external
						...
						<p>
							...
							,{" "}
							<a href="http://visap.net/2018/media/Glissmann-VISAP18-AP.pdf">
								4
							</a>
							,{" "}
							<a href="http://visap.net/2018/media/Hunter-VISAP18-AP.pdf">5</a>)
							from the inaugural edition of this format in the{" "}
							<a href="http://visap.net/2018/program">2018 program</a>, the
							three pictorials (
							...
							and{" "}
							<a href="https://visap.net/media/vis20m-sub1047-cam-i7.pdf">2</a>)
							in the{" "}
							<a href="https://visap.net/2020/program.html">2020 program</a>,
							...
							<a href="https://ieeexplore.ieee.org/document/9623000">5</a>) in
						...
						<p>
							...
							digital library. Pictorials will be part of the VISAP’22
							exhibition as printed booklets and showcased in the VISAP’22
							catalog, which will be available both online and in print.
							Selected submissions will be invited to present their work -
							virtual or in-person - in one of the VISAP Papers sessions during
							the conference.
						</p>
						<h3>Exhibition instructions</h3>
						<p>
							We invite artists and designers to submit data-driven artworks
							related to the theme <i>Mingling Spaces</i>. We welcome
							submissions in any medium, e.g., interactive projections,
							multimedia sculptures, mobile devices, illustrations,
						...
						<ol>
							...
							<li>
								...
								interactive elements. Explain how your work relates to this
								year’s theme and how it links to information visualization,
								scientific visualization, and/or visual analytics. Discuss the
								reception of your work at previous exhibitions (if it has been
								exhibited before)
							</li>
							<li>
								...
								details of the project. For instance, can your exhibit be
								viewable online? Does it require the audience to interact with
								it live? Are there any time of day requirements? Does it require
								any specific space or technical setup (e.g. VR gadgets or
								audiovisual equipment)? Consider how your artwork could be
								integrated in both a physical and virtual art exhibition
							</li>
							<li>
								<strong>Supporting Material</strong>: Provide links to
								high-resolution images, audio, webpages and/or videos that will
						...
						<p>
							Submitting additional images, videos, or audio files as
						...
						<p>
							...
							artworks that have been accepted previously. Please feel welcome
						...
						<p>
							...
							be shared on the visap website. In addition to accepting
							installations that may be featured on the in-person or online
							exhibition, some artworks may be selected for artist talks during
							the week of the IEEE VIS conference. Performance submissions may
							also be scheduled for specific times during the exhibition.
							Artists will work with the VISAP organizers on details for
							showcasing their artworks in the online exhibition. Artists and
							authors are strongly encouraged to participate in the VISAP
							program throughout the week.
						</p>
						<p>
							No artist fees or travel costs are provided. There are some
							complimentary registrations available for selected artists.
							Priority will be given to exhibiting artists who are independent
							artists and not affiliated with institutions.
						</p>
						<p>
						...
						<p>
							All submissions must be made using the IEEE VGTC Electronic
							Conference System (on PCS). After creating an account or signing
							in, submitters will find the VISAP’22 Papers and Exhibition
							submissions by:
						</p>
						<ol>
						...
						<p>
							VISAP uses a single-blind review process: submitted material is
							not required to be anonymized.
						</p>
						<p>
							At least one author per accepted paper and pictorial is required
							to register to the IEEE VIS conference to present the work (either
							virtually or in-person). Submitters of accepted exhibits are also
							strongly encouraged to attend the conference to set up their work
							for the opening reception, and to participate in the program
							throughout the week (again, either virtually or in-person).
							<br />
							No artist fee is provided. There are some complimentary day
							registrations available for selected artists. Priority will be
							given to exhibiting artists. We invite students to apply to the
							IEEE VIS student volunteer program to help cover registration
							fees. We also invite authors and artists who demonstrate financial
							need to apply for the IEEE VIS Inclusivity & Diversity
							Scholarship.
						</p>
					</Col>
				</Row>
